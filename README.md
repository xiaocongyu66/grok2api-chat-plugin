...
| 单次最多传图数 | 默认 4 |
| **对话内工具 chatToolsEnable** | 开=**仅明确要画/生成图视频**时挂 tools；「描述」只用文字；结果合并转发 |
| 工具：生图 / 生视频 | 可分别开关；规范见 [docs/TOOLS.md](docs/TOOLS.md) |
...
| 开关 | 默认 | 说明 |
|------|------|------|
| **是否支持私聊 privateChatEnable** | **开** | 关=私聊不响应对话/生图/生视频 |
| **私聊用户可自己开/关 privateSessionSelfStart** | **开** | 需先开「支持私聊」；关=私聊也仅主人开会话 |
